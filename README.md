...
Пример архива с решением размещен по ссылке [_sample\_submission.zip_](https://n-ws-f21jf.s3pd02.sbercloud.ru/b-ws-f21jf-ny6/FBC2/sample_submission_1_3b.zip).
