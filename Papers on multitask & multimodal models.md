 ...
 * Cross attention layers - встраиваются между замороженными обученными слоями LM. Эти слои позволяют включать визуальную информацию в задаче предсказания следующего токена.
