...
3. [Attention Bottlenecks for Multimodal Fusion](https://arxiv.org/abs/2107.00135) (Multimodal Bottleneck Transformer (MBT), `Nagrani, Arsha et al., 2021`) - оригинальный подход к работе с мультимодальными входами (в основном видео и аудио) со средним уровнем слияния.
